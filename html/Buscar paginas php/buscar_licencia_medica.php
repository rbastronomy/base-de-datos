    ...
    <script>
        ...
        function updateLicenciaMedica(row) {
            ...
            var data = {
                ...
                lugar_reposo: cells[2].innerText,
                centro_medico: cells[3].innerText,
                f_otorgamiento: cells[4].innerText,
                f_inicio_reposo: cells[5].innerText,
                f_termino_reposo: cells[6].innerText,
                diagnostico: cells[7].innerText,
                medico: cells[8].innerText
            };
