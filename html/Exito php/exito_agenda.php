...
<head>
    ...
    <title>Éxito al crear el Agenda</title>
...
<body>
    <div class="container">
        <h1>Éxito al crear el Agenda</h1>
        <p>La Agenda se ha creado correctamente.</p>
        <a href="crear_agenda.php" class="back-button back-to-creation-button">Volver a la creación de Agenda</a>
