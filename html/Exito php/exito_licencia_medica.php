...
<head>
    ...
    <title>Éxito al crear el beneficio</title>
    <link rel="stylesheet" href="exito_decoracion.css">
</head>
<style>
    .menu-btn {
            position: absolute;
...
<body>
    <div class="container">
        <h1>Éxito al crear la Licencia Medica</h1>
        <p>La Licencia Medica se ha creado correctamente.</p>
        <a href="crear_licencia_medica.php" class="back-button back-to-creation-button">Volver a la creación de Licencia Medica</a>
